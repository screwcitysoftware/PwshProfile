function Enable-AzureCliCompletion {
    ...
    Register-ArgumentCompleter -Native -CommandName az -ScriptBlock {
        ...
        try {
            ...
            $null = az 2>&1
            Get-Content $completionFile | Sort-Object | ForEach-Object {
                [System.Management.Automation.CompletionResult]::new($_, $_, "ParameterValue", $_)
            }
        }
        finally {
            Remove-Item $completionFile, Env:\_ARGCOMPLETE_STDOUT_FILENAME, Env:\ARGCOMPLETE_USE_TEMPFILES, Env:\COMP_LINE, Env:\COMP_POINT, Env:\_ARGCOMPLETE, Env:\_ARGCOMPLETE_SUPPRESS_SPACE, Env:\_ARGCOMPLETE_IFS, Env:\_ARGCOMPLETE_SHELL -ErrorAction SilentlyContinue
        }
    }
}
